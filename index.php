...
<head>
  ...
  <title><?php echo $row["namez"];?></title>
...
<body>
  ...
  <header id="header" class="fixed-top">
    <div class="container d-flex align-items-center justify-content-between">
      ...
      <h1 class="logo"><a href="index.html"><?php echo $row["namez"];?></a></h1>
                                          ...
                                          <?php  
                                                          if (isset($_GET['notfound'])) {
                                                              echo'<div class="alert alert-success" >
                                                                 ...
                                                                 <strong>Error!! </strong><p> Package not found pls check the ID and try again</p>
                                                                 </div>';
                                                          }    
    ...
    <div class="container position-relative" data-aos="fade-up" data-aos-delay="100">
      <div class="row justify-content-center">
        <div class="col-xl-7 col-lg-9 text-center">
          ...
          <input type="text" name="ID" class="form-control" id="ID" placeholder="Your Tracking Code" required>
            
          <div class="text-center">
        <button type="submit" name="submit" class="btn-get-started scrollto">Get Started</button>
      </div>
           </form>
